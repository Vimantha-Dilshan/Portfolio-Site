    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="card  ">
                    <div class="card-header">
                        <h5 class="card-title">Existing Educational Qualifications</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    if ($result->num_rows > 0) {
                                        if (!$conn) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<div class='ms-3'>";
                                                echo "<p class='fw-bold mb-1'>" . $row["degree_name"] . "</p>";
                                                echo "<p class='fw-normal mb-1'>" . $row["institute"] . "</p>";
                                                ...
                                                echo "<a href='server/APIs/delete_education.php?rn=$row[id]><button type='button' class='btn btn-danger btn-rounded'><i class='fas fa-trash-alt'></i></button></>";
                                                echo "</td>";
                        ...
                        <button type="button" class="btn btn-primary btn-rounded" data-mdb-toggle="modal" data-mdb-target="#showData">
                            Modal Test
                        </button>

                        <!-- Modal -->
                        <div class="modal top fade" id="showData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mdb-backdrop="true" data-mdb-keyboard="true">
                            <div class="modal-dialog modal-lg ">
                                <div class="modal-content">

                                    <div class="modal-header">
                                        <h5 class="modal-title text-success" id="exampleModalLabel">Bachelor's Degree in Computer Science & Software Engineering</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="card  ">
                                                    <div class="card-body">
                                                        <p class="card-text">
                                                        <h4>University of Bedfordshire</h4>
                                                        <h6 class="text-danger">2020-2022</h6>
                                                        </p>
                                                    </div>
                                                    <div class="card-footer text-secondary">Institute Details</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="card  ">
                                                    <div class="card-body">
                                                        <p class="card-text">
                                                            Foundation in databases and computer networks, software engineering, computational thinking, programming, and data structures.
                                                        </p>
                                                    </div>
                                                    <div class="card-footer text-secondary">Description</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary btn-rounded btn-sm" data-mdb-dismiss="modal">
                    ...
                    <div class="card-footer">
                        <small><i class="fas fa-info-circle"></i> All educationsal qualifications are shown here</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="card  ">
                    <div class="card-header">
                        <h5 class="card-title">Create Educational Qualification</h5>
                    </div>
                    <div class="card-body">

                        <form method="POST" action="server/APIs/store_education.php">
                            <div class="form-outline mb-4">
                                <input type="text" id="txtName" name="txtName" class="form-control" />
                                <label class="form-label" for="form6Example3"><i class="fas fa-graduation-cap"></i> Degree/Certificate Name</label>
                            </div>

                            <div class="row mb-4">
                                <div class="col-8">
                                    <div class="form-outline">
                                        <input type="text" id="txtInstitute" name="txtInstitute" class="form-control" />
                                        <label class="form-label" for="form6Example1"><i class="fas fa-landmark"></i> Institute</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-outline">
                            ...
                            <div class="form-outline mb-4">
                                <textarea class="form-control" id="txtDesc" name="txtDesc" rows="17"></textarea>
                                <label class="form-label" for="form6Example7"><i class="fas fa-align-center"></i> Description</label>
                            </div>

                            <!-- Submit button -->
                            <div class="text-end">
                                <a href="server/APIs/refresh_education.php"><button type="button" class="btn btn-secondary btn-rounded">Cancel</button></a>
