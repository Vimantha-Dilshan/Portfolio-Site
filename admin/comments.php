            ...
            <div class="col-sm-8">
                <div class="card  ">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h6 class="text-danger">Published Feedbacks</h6>
                                    </div>
                                </div>
                                            ...
                                            if ($result->num_rows > 0) {
                                                if (!$conn) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<p class='fw-normal mb-1'>" . $row["project"] . "</p>";

                                                        echo "<p class='mb-0 text-warning'>";
                                                        for ($x = 1; $x <= $ratedStars; $x++) {
                                                            echo "<i class='fas fa-star'></i>";
                                                        }
                                                        echo "</p>";

                                                        //echo "<p class='mb-0 text-warning'>" . $row["stars"] . "</p>";
                                                        echo "</div>";
                                                        echo "</div>";
                                                        echo "</td>";
                                                        ...
                                                        echo "<a href='server/APIs/delete_comment.php?rn=$row[id]'><button type='button' class='btn btn-danger btn-rounded'><i class='fas fa-trash-alt'></i></button></>";
                                                        echo "<a href='server/APIs/unpublish_comment.php?rn=$row[id]'><button type='button' class='btn btn-secondary btn-rounded'><i class='fas fa-times'></i></button></a>";
                                                        echo "</td>";
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h6 class="text-danger">Pending Feedbacks</h6>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle mb-0 bg-white table-hover table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * from comments WHERE approve=0 ORDER BY id DESC";
                                            $result = $conn->query($sql);
                                            ...
                                            if ($result->num_rows > 0) {
                                                if (!$conn) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<a href='#'><button type='button' class='btn btn-secondary btn-rounded'><i class='fas fa-info-circle'></i></button></a>";
                                                        echo "<a href='server/APIs/delete_comment.php?rn=$row[id]'><button type='button' class='btn btn-danger btn-rounded'><i class='fas fa-trash-alt'></i></button></>";
                                                        echo "<a href='server/APIs/publish_comment.php?rn=$row[id]'><button type='button' class='btn btn-success btn-rounded'><i class='fas fa-check'></i></button></a>";
                                                        echo "</td>";
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="ms-3">
                                                            <p class="fw-bold mb-1">Pathum Madhawa</p>
                                                            <p class="fw-normal mb-1">Online Mobile</p>
                                                            <p class="mb-0 text-warning"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-secondary btn-rounded"><i class="fas fa-info-circle"></i></button>
                                                    <button type="button" class="btn btn-success btn-rounded"><i class="fas fa-check"></i></button>
                                                    <button type="button" class="btn btn-danger btn-rounded"><i class="fas fa-times"></i></button>
                                                </td>
                                            </tr> -->
                    ...
                    <div class="card-footer">
                        <small><i class="fas fa-info-circle"></i> All comments are shown here</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="card  ">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="server/APIs/store_comment.php">
                            <div class="form-outline mb-4">
                                <input type="text" id="txtName" name="txtName" class="form-control" />
                                <label class="form-label" for="form6Example3"><i class="fas fa-user-tie"></i> Name</label>
                            </div>

                            <div class="row mb-4">
                                <div class="col-8">
                                    <div class="form-outline">
                                        <input type="text" id="txtProject" name="txtProject" class="form-control" />
                                        <label class="form-label" for="form6Example1"><i class="fas fa-hotel"></i> Project</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-outline">
                                        <input type="number" id="txtStars" name="txtStars" class="form-control" max="5" />
                                        <label class="form-label" for="form6Example2"><i class="far fa-calendar"></i> Stars</label>
                                    </div>
                                </div>
                            </div>

                            <div class="form-outline mb-4">
                                <textarea class="form-control" id="txtFeedback" name="txtFeedback" rows="17"></textarea>
                                <label class="form-label" for="form6Example7"><i class="fas fa-align-center"></i> Feedback</label>
                            </div>

                            <!-- Submit button -->
                            <div class="text-end">
                                <button type="button" class="btn btn-secondary btn-rounded">Cancel</button>
                                <button type="submit" id="submit" name="submit" class="btn btn-success btn-rounded">Add Comment</button>
                            </div>
                        </form>
                    </div>
